...
public class GitUrl
{
	static private List<Regex> UrlSchemas = new List<Regex>()
	{
		...
		//base
		new Regex(
			@"(?<user>.+)s@(?<hostname>.+)s:(?<reponame>.+)s.git",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
		new Regex(
			@"(http://(?<hostname>.+)s/(?<reponame>.+)s.git)",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
		new Regex(
			@"(http://(?<hostname>.+)s/(?<reponame>.+)s.git)",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
		new Regex(
			@"^(git://(?<hostname>.+)s/(?<reponame>.+)s.git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),

		//assembla
		new Regex(
			@"^(git@(?<hostname>.+):(?<reponame>.+).git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
		new Regex(
			@"^(git://(?<hostname>.+)/(?<reponame>.+).git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
		...
		//bitbucket
		new Regex(
			@"^(https://(?<user>.+)@(?<hostname>.+)/(?<owner>.+)/(?<reponame>.+).git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
		new Regex(
			@"^(git@(?<hostname>.+):(?<owner>.+)/(?<reponame>.+).git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),

		//friendcode
		new Regex(
			@"^(https://(?<hostname>.+)/(?<owner>.+)@user/(?<reponame>.+).git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),

		//github
		new Regex(
			@"^(https://(?<hostname>.+)/(?<owner>.+)/(?<reponame>.+).git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
		new Regex(
			@"^(git@(?<hostname>.+):(?<owner>.+)/(?<reponame>.+).git)$",
			RegexOptions.Compiled | RegexOptions.IgnoreCase),
